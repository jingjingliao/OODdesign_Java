...
public class Seat {
   ...
   * @throws InvalidArgumentsException if seat name is invalid
   */
  public Seat(String seatName) throws InvalidArgumentsException {
    reserveFor = null;
   ...
   * @throws InvalidArgumentsException if seat name is invalid
   */
  private String isValidSeatName(String seatName) throws InvalidArgumentsException {
    if (!seatName.matches("[A-Z]*") || !this.upperCaseLetter(seatName))
      throw new InvalidArgumentsException("Seat name should be the capital letter from A to Z");
    else
      return seatName;
  }
